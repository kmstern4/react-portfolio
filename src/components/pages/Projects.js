...
import StyledSpace from '../styledComponents/StyledSpace';
// import './anim.css';
            ...
            <Column size='six'>
                <ProjDiv>
                    ...
                    <ProjDesc>
                        ...
                        <a href='https://github.com/kmstern4/trainScheduler' target='_blank'><Logo src ='assets/git.png' alt='GitHub' />GitHub</a><StyledSpace src='assets/spacer.png' /><a href='https://kmstern4.github.io/trainScheduler/' target='_blank'>Live App</a>
                    </ProjDesc>
                </ProjDiv>
            ...
            <Column size='six'>
                <ProjDiv>
                    ...
                    <ProjDesc>
                        ...
                        <a href='https://github.com/kmstern4/TriviaGame' target='_blank'><Logo src ='assets/git.png' alt='GitHub' />GitHub</a><StyledSpace src='assets/spacer.png' /><a href='https://kmstern4.github.io/TriviaGame/' target='_blank'>Live App</a>
                    </ProjDesc>
                </ProjDiv>
            ...
            <Column size='six'>
                <ProjDiv>
                    ...
                    <ProjDesc>
                        ...
                        <a href='https://github.com/kmstern4/FriendFinder' target='_blank'><Logo src ='assets/git.png' alt='GitHub' />GitHub</a><StyledSpace src='assets/spacer.png' /><a href='https://fathomless-brushlands-61032.herokuapp.com/' target='_blank'>Live App</a>
                    </ProjDesc>
                </ProjDiv>
